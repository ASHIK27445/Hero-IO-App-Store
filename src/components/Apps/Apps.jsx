    ...
    return(
        <div>
            <div className="text-center mt-20 mb-10">
                <h2 className="text-[#001931] font-bold text-[42px]">Our All Applications</h2>
                <p className="text-[#627382] textarea-md mt-2">Explore All Apps on the Market developed by us. We code for Millions</p>
            </div>
            <div className="flex justify-between items-center my-4 max-w-[1064px] mx-auto gap-5">
                <h3 className="text-[#001931] font-semibold text-lg">({filterSearch.length}) Apps Found</h3>
                <div>
