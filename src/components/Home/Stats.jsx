const Stat = () => {
  return (
    <div className="stats shadow font-inter text-white flex justify-center max-w-[1140px] mx-auto">
      <div className="stat place-items-center px-12">
        <div className="stat-title text-sm text-white">Total Downloads</div>
        <div className="stat-value font-extrabold text-[50px] my-3">29.6M</div>
      ...
      <div className="stat place-items-center">
        ...
        <div className="stat-value font-extrabold text-[50px] my-3">906K</div>
      ...
      <div className="stat place-items-center">
        ...
        <div className="stat-value font-extrabold text-[50px] my-3">132+</div>
