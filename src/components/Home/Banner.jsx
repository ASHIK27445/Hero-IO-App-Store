...
const Banner = () => {
    return(
        <div className="max-w-[1140px] mx-auto text-center font-inter mt-20 mb-10">
            ...
            <div>
                <button className="btn font-semibold text-lg text-[#001931] rounded-sm mr-4"> <img className='h-[28px]' src={googlePlaystoreLogo} alt="google playstor logo" /> Play Store</button>
                <button className="btn font-semibold text-lg text-[#001931] rounded-sm"> <img className='h-[28px]' src={appstoreLogo} alt="google playstor logo" /> App Store</button>
            </div>
        </div>
    )
}
