...
const AppCard = ({ appData }) => {
  ...
  return (
    ...
    {/* //*👈 pass the whole object here/* */}
      <div className="border-2 border-black max-w-[180px] lg:max-w-[250px] w-full overflow-hidden h-[300px] p-4 rounded-md cursor-pointer lg:shadow-gray-600 hover:shadow-lg transition">
